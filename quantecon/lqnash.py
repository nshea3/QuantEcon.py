...
def nnash(A, B1, B2, R1, R2, Q1, Q2, S1, S2, W1, W2, M1, M2,
    ...
    params = A, B1, B2, R1, R2, Q1, Q2, S1, S2, W1, W2, np.atleast_2d(M1), np.atleast_2d(M2)
    ...
    for it in range(max_iter):
        ...
        F1_right = (H1 @ A)+(G1 @ W1.T) - (H1@B2 + G1@M1.T) @ (H2@A + G2@W2.T)
        F1 = solve(F1_left, F1_right)

        # issue with this! what happens here? 
